...
- BetterEnemiesConfig.cs: Example of ModConfig for custom mod settings;
- BetterEnemiesGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- BetterEnemiesMain.cs: Main mod class, recieves mod management and general events;
- BetterEnemiesTactical.cs: Example of ModTactical for modifying tactical level;
